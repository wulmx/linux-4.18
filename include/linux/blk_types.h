...
struct bio {
	 ...
	 */
	unsigned int		bi_phys_segments;//合并后段数量

	/*
	 * To keep track of the max segment size, we account for the
	 * sizes of the first and last mergeable segments in this bio.
	 * 第一个可合并段的大小，与request合并相关
	 */
	...
	bio_end_io_t		*bi_end_io;//bio结束时的回调，通知完成情况
	/* 该bio结束时的回调函数，一般用于通知调用者该bio的完成情况 */
	void			*bi_private;
